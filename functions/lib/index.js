...
exports.logHydration = functions.https.onRequest((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (req.method !== 'POST') {
    ...
    try {
        yield db.collection('hydration_logs').add({
            userId: userId,
            amount: amount,
            timestamp: new Date(timestamp), // Assuming timestamp is a string or number that can be converted to a Date
